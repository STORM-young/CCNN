...
namespace MFarm.AStar
{
    public class AStar : Singleton<AStar>
    {
        ...
        private HashSet<Node> closedNodeList;   //所有被选中的路径点
        ...
        {
            if(GridMapManager.Instance.GetGridDimensions(sceneName, out Vector2Int gridDimensions, out Vector2Int gridOrigion))
            {
                ...
                originX = gridOrigion.x;
                originY = gridOrigion.y;
            ...
            //gridNodes范围是从(0,0)开始所以要减去原点坐标得到实际位置
