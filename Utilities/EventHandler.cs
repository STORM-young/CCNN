...
public static class EventHandler
{
    ...
    {
        //？.是简写，先判断UpdateInventoryUI是否为空，不空再Invoke
    ...
    public static event Action<DialougePiece> ShowDialogueEvent;

    public static void CallShowDialogueEvent(DialougePiece piece)
    {
